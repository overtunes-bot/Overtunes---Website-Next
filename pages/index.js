      ...
      <section className='border-[#3C4652] border-2 p-10'>
        <div className='border-[#3C4652] border-2 p-5'>
          ...
          <div className='flex-col flex md:flex-row gap-4 mt-3 justify-center'>
            <a href='https://discord.com/oauth2/authorize?client_id=873101608467185684&scope=bot&permissions=4332047432&scope=applications.commands%20bot' rel='noopener noreferrer' target={'_blank'}><button className='bg-[#3C4652] transition duration-300 hover:opacity-80 text-gray-200 font-bold w-full md:w-56 lg:w-72 rounded-xl py-2 md:p-4 md:text-2xl'>Invite</button></a>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 text-center">
            <div className="p-4 sm:w-1/4 w-1/2 border-[#3C4652] border-2">
              <h2 className="title-font font-medium sm:text-4xl text-3xl text-gray-200">150K+</h2>
